...
class Image:
    ...
    @property
    def fiducials(self) -> NDArray[Union[int, float]]:
        return self._fiducials

    @fiducials.setter
    def fiducials(self, value: NDArray[Union[float]]) -> None:
    ...
    def SetImageFiducial(
        self, fiducial_index: int, position: Union[Sequence[float], NDArray[float]]
    ) -> None:
    ...
    def GetImageFiducials(self) -> NDArray[Union[float]]:
    ...
    def GetImageFiducialForUI(self, fiducial_index: int, coordinate: int) -> Union[Any, float]:
    ...
    def OnStateProject(self, state: Any) -> None:
        if state:
